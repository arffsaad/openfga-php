 ...
 *
 *
 * @method string getUserset()
 * @method $this setUserset($userset)
 *
 */
class Computed implements ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Computed';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userset'] === null) {
            $invalidProperties[] = "'userset' can't be null";
        }
