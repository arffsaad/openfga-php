 ...
 *
 *
 * @method \RuncloudIO\SDK\OPENFGA\Model\User[] getUsers()
 * @method $this setUsers($users)
 *
 */
class ListUsersResponse implements ModelInterface
{
    ...
    protected static $swaggerTypes = [
        'users' => '\RuncloudIO\SDK\OPENFGA\Model\User[]'
    ];
     ...
     * Constructor
     *
     * @param \RuncloudIO\SDK\OPENFGA\Model\User[] $users users 
     ...
     * Gets users
     *
     * @return \RuncloudIO\SDK\OPENFGA\Model\User[]
     */
