...
/**
 * ValidationErrorMessageResponse Class Doc Comment
 *
 * Required Attributes:
 *
 * @category Class
 ...
 *
 *
 * @method \RuncloudIO\SDK\OPENFGA\Model\ErrorCode getCode()
 * @method $this setCode($code)
 * @method string getMessage()
 * @method $this setMessage($message)
 *
 */
class ValidationErrorMessageResponse implements ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ValidationErrorMessageResponse';
    ...
    protected static $swaggerTypes = [
        'code' => '\RuncloudIO\SDK\OPENFGA\Model\ErrorCode',
        'message' => 'string'
    ];
     ...
     * Constructor
     *
     * @param \RuncloudIO\SDK\OPENFGA\Model\ErrorCode $code code 
