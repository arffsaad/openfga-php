...
/**
 * ReadAuthorizationModelsResponse Class Doc Comment
 *
 * Required Attributes:
 ...
 *
 *
 * @method \RuncloudIO\SDK\OPENFGA\Model\AuthorizationModel[] getAuthorizationModels()
 * @method $this setAuthorizationModels($authorization_models)
 * @method string getContinuationToken()
 * @method $this setContinuationToken($continuation_token)
 *
 */
class ReadAuthorizationModelsResponse implements ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReadAuthorizationModelsResponse';
    ...
    protected static $swaggerTypes = [
        'authorization_models' => '\RuncloudIO\SDK\OPENFGA\Model\AuthorizationModel[]',
     ...
     * Constructor
     *
     * @param \RuncloudIO\SDK\OPENFGA\Model\AuthorizationModel[] $authorization_models authorization_models 
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authorization_models'] === null) {
     ...
     *
     * @param string $continuation_token The continuation token will be empty if there are no more models.
     *
     * @return $this
     */
